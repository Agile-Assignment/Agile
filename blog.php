...
<?php
     ...
     $sql = "SELECT Names, Rate, Message, DATE (Timeline) as Date  FROM rating ORDER BY ReviewID";
     $result = mysqli_query($conn, $sql);
                              ...
                              <div class="row">
								...
								<div class="col-sm-6 col-xs-6">
                                     <div class="form-group">
										...
										oninput="this.nextElementSibling.value = this.value" name="rating"><output>5 </output><br>                                        </div>
                                </div>
                              </div>
